...
[Binding]
public sealed class UpdateProductStepDefinition
{
    ...
    public UpdateProductStepDefinition(ScenarioContext scenarioContext)
    {
    ...
    [When(@"the ""(.*)"" is updated with those values")]
    public void WhenTheIsUpdatedWithThoseValues(string product)
    {
        ...
        var request = new HttpRequestMessage(HttpMethod.Put, $"http://localhost:5000/api/products/${_product.Id}")
        {
