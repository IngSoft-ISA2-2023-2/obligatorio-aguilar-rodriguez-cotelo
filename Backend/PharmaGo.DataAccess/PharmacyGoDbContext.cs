...
namespace PharmaGo.DataAccess
{
    public class PharmacyGoDbContext : DbContext
    {
        ...
        public DbSet<PurchaseDetailProduct> PurchaseDetailProducts { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder) {
            ...
            modelBuilder.Entity<PurchaseDetailProduct>().Property(property => property.Price).HasPrecision(14, 2);
